# python build stubs for package dnaencoding
...
mod = Module('_dnaencoding')
mod.add_include('"dnaencoding_go.h"')
...
mod.add_function('Map_rune_byte_CTor', retval('int64_t'), [])
mod.add_function('Map_rune_byte_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_rune_byte_elem', retval('uint8_t'), [param('int64_t', 'handle'), param('int32_t', '_ky')])
mod.add_function('Map_rune_byte_contains', retval('bool'), [param('int64_t', 'handle'), param('int32_t', '_ky')])
mod.add_function('Map_rune_byte_set', None, [param('int64_t', 'handle'), param('int32_t', 'key'), param('uint8_t', 'value')])
mod.add_function('Map_rune_byte_delete', None, [param('int64_t', 'handle'), param('int32_t', '_ky')])
mod.add_function('Map_rune_byte_keys', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('dnaencoding_Encoding', retval('int64_t'), [])
mod.add_function('dnaencoding_Set_Encoding', None, [param('int64_t', 'val')])
add_checked_function(mod, 'dnaencoding_Encode', retval('int64_t'), [param('char*', 'dna')])

mod.generate(open('dnaencoding.c', 'w'))
