...
//
extern long long int Map_rune_byte_CTor();
extern GoInt Map_rune_byte_len(long long int handle);
extern char Map_rune_byte_elem(long long int handle, long int _ky);
extern char Map_rune_byte_contains(long long int handle, long int _ky);
extern void Map_rune_byte_set(long long int handle, long int _ky, char _vl);
extern void Map_rune_byte_delete(long long int handle, long int _ky);
extern long long int Map_rune_byte_keys(long long int handle);

// ---- Global Variables: can only use functions to access ---
//
extern long long int dnaencoding_Encoding();
extern void dnaencoding_Set_Encoding(long long int val);
extern long long int dnaencoding_Encode(char* dna);
